 ...
 * transitions are expressed as factory-style {@code with...} methods that return
...
public record Order(
    ...
    /** Transition after a temporary pricing failure: stays PENDING_PRICING, eligible for another attempt later. */
    ...
    /** Transition to PRICING_FAILED: either a permanent provider error or retries exhausted. */
